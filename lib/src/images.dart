...
class PostoryImages {
  ...
  static final pocoin_postcard = _pocoinImage('postcard.png');
  static final pocoin_stamp = _pocoinImage('stamp.png');
  ...
  static final virtual_address_search = _virtualAddressImage('v_search.png');
